    ...
    def __init__(self,config):
        ...
        if config.pretrained is not None:
            ...
            self.i3d.load_state_dict(torch.load(
                '/Users/zz/Documents/group-activity-transformer-dist_tb_v23/checkpoint/rgb_imagenet.pt'))
        else:
...
if __name__=="__main__":
    ...
    #model.load_state_dict(torch.load('/Users/zz/Documents/group-activity-transformer-dist_tb_v23/checkpoint/rgb_imagenet.pt'))
    #action=model(input)
    model=i3d(832,256)
    action=model(input)
    print(action.shape)